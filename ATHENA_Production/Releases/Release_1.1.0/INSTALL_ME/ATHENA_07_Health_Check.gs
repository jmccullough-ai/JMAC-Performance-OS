...
function ATHENA_runHealthCheck() {
  ...
  results.push(ATHENA_checkHeader_(ss, ATHENA_PRODUCTION.sheets.coachPhilosophy, ['Principle_ID', 'Principle', 'Description', 'Training_Implication', 'Active']));
  results.push(ATHENA_checkHeader_(ss, ATHENA_PRODUCTION.sheets.coachDna, ['Rule_ID', 'Rule_Category', 'Rule_Name', 'If_Condition', 'Then_Action', 'Priority', 'Applies_To', 'Active']));
  results.push(ATHENA_checkHeader_(ss, ATHENA_PRODUCTION.sheets.movementFamilies, ['Family_ID', 'Movement_Family', 'Primary_Quality', 'Progression_Level_1', 'Progression_Level_2', 'Progression_Level_3', 'Progression_Level_4', 'Progression_Level_5', 'Progression_Level_6', 'Notes', 'Active']));
